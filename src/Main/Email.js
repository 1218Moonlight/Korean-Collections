...
export default withStyles(styles)(function Email(props) {
    const {classes} = props;
    return (
        ...
        <form className={classes.container} noValidate autoComplete={"off"}
            ...
            <Button className={classes.submit} type={"submit"} fullWidth={"true"} color={"primary"} variant="contained">Send</Button>
